    ...
    translation: {
      ...
      devices: {
        ...
        detailsSources: {
          ...
          cloudAnnounce: '云端地址通告',
          lanSwimWebSocket: 'LAN SWIM / WebSocket',
        },
        routes: {
          lan: '局域网',
          cloud: '云端中继',
    ...
    translation: {
      ...
      devices: {
        ...
        detailsFields: {
          ...
          activeRoute: '現在の経路',
          securityState: 'セキュリティ状態',
          localEndpoint: 'LAN エンドポイント',
    ...
    translation: {
      ...
      devices: {
        ...
        detailsFields: {
          ...
          securityState: 'Estado de seguridad',
          localEndpoint: 'Endpoint LAN',
        ...
        detailsSources: {
          ...
          cloudAnnounce: 'Anuncio en la nube',
          lanSwimWebSocket: 'LAN SWIM / WebSocket',
        },
        routes: {
          lan: 'LAN',
    ...
    translation: {
      ...
      devices: {
        ...
        detailsFields: {
          ...
          securityState: 'Sicherheitsstatus',
          localEndpoint: 'LAN-Endpunkt',
        ...
        detailsSources: {
          ...
          cloudAnnounce: 'Cloud-Ankündigung',
          lanSwimWebSocket: 'LAN SWIM / WebSocket',
        },
        routes: {
          lan: 'LAN',
    ...
    translation: {
      ...
      devices: {
        ...
        detailsFields: {
          ...
          securityState: 'Статус безопасности',
          localEndpoint: 'LAN endpoint',
        ...
        detailsSources: {
          ...
          cloudAnnounce: 'Объявление из облака',
          lanSwimWebSocket: 'LAN SWIM / WebSocket',
        },
        routes: {
          lan: 'LAN',
