...
fn text_en(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ReceiveFileTitle => "Receive file",
        TextKey::ReceiveFilePrompt => "{sender} wants to send {file}\nSize: {size} bytes",
...
fn text_zh_cn(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ReceiveFileTitle => "接收文件",
        TextKey::ReceiveFilePrompt => "{sender} 想发送文件 {file}\n大小: {size} 字节",
...
fn text_zh_tw(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ReceiveFileTitle => "接收檔案",
        TextKey::ReceiveFilePrompt => "{sender} 想傳送檔案 {file}\n大小: {size} 位元組",
...
fn text_ja(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ReceiveFileTitle => "ファイルを受信",
        TextKey::ReceiveFilePrompt => {
            "{sender} が {file} を送信しようとしています\nサイズ: {size} バイト"
        }
...
fn text_ko(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ReceiveFileTitle => "파일 받기",
        TextKey::ReceiveFilePrompt => {
            "{sender} 님이 {file} 파일을 보내려고 합니다\n크기: {size}바이트"
        }
...
fn text_es(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ReceiveFileTitle => "Recibir archivo",
        TextKey::ReceiveFilePrompt => "{sender} quiere enviar {file}\nTamaño: {size} bytes",
...
fn text_de(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ReceiveFileTitle => "Datei empfangen",
        TextKey::ReceiveFilePrompt => "{sender} möchte {file} senden\nGröße: {size} Byte",
...
fn text_ru(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::ReceiveFileTitle => "Получить файл",
        TextKey::ReceiveFilePrompt => "{sender} хочет отправить {file}\nРазмер: {size} байт",
