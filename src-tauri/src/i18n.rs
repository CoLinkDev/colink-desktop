...
pub enum TextKey {
    ...
    FileChecksumFailed,
    TransferUserCancelled,
    TransferUserRejected,
    TransferChecksumMismatch,
    TransferStorageFull,
    TransferGeneric,
    TransferRelayInactive,
    TransferConnectionClosed,
    TransferSizeMismatch,
    TransferHttpsIncomplete,
    TransferOfferExpired,
    TransferLanFailed,
    TransferRouteMismatch,
    DeviceNotConnected,
...
fn text_en(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::TrayLan => "LAN",
        TextKey::TrayNoReachableDevices => "No reachable devices",
        TextKey::TrayViewAllDevices => "View all devices...",
        ...
        TextKey::TransferUserCancelled => "Transfer cancelled",
        TextKey::TransferUserRejected => "Recipient rejected the transfer",
        TextKey::TransferChecksumMismatch => "File checksum verification failed",
        TextKey::TransferStorageFull => "Storage full at destination",
        TextKey::TransferGeneric => "Transfer failed",
        TextKey::TransferRelayInactive => "Transfer timed out due to inactivity",
        TextKey::TransferConnectionClosed => "Connection closed",
        TextKey::TransferSizeMismatch => "File size mismatch",
        TextKey::TransferHttpsIncomplete => "HTTPS transfer did not complete",
        TextKey::TransferOfferExpired => "Transfer offer expired",
        TextKey::TransferLanFailed => "LAN connection failed",
        TextKey::TransferRouteMismatch => "Control plane route mismatch",
...
fn text_zh_cn(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::TrayLan => "局域网",
        TextKey::TrayNoReachableDevices => "暂无可达设备",
        TextKey::TrayViewAllDevices => "查看全部设备...",
        ...
        TextKey::TransferUserCancelled => "传输已取消",
        TextKey::TransferUserRejected => "接收方拒绝了文件传输",
        TextKey::TransferChecksumMismatch => "文件校验失败",
        TextKey::TransferStorageFull => "接收方存储空间不足",
        TextKey::TransferGeneric => "传输失败",
        TextKey::TransferRelayInactive => "传输超时，网络不活跃",
        TextKey::TransferConnectionClosed => "连接已断开",
        TextKey::TransferSizeMismatch => "文件大小不匹配",
        TextKey::TransferHttpsIncomplete => "HTTPS 传输未完成",
        TextKey::TransferOfferExpired => "传输请求已过期",
        TextKey::TransferLanFailed => "局域网连接失败",
        TextKey::TransferRouteMismatch => "控制平面路由不匹配",
...
fn text_zh_tw(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::TrayNoReachableDevices => "暫無可達設備",
        TextKey::TrayViewAllDevices => "查看所有設備...",
        ...
        TextKey::TransferUserCancelled => "傳輸已取消",
        TextKey::TransferUserRejected => "接收方拒絕了檔案傳輸",
        TextKey::TransferChecksumMismatch => "檔案校驗失敗",
        TextKey::TransferStorageFull => "接收方儲存空間不足",
        TextKey::TransferGeneric => "傳輸失敗",
        TextKey::TransferRelayInactive => "傳輸逾時，網路不活躍",
        TextKey::TransferConnectionClosed => "連線已中斷",
        TextKey::TransferSizeMismatch => "檔案大小不符",
        TextKey::TransferHttpsIncomplete => "HTTPS 傳輸未完成",
        TextKey::TransferOfferExpired => "傳輸請求已過期",
        TextKey::TransferLanFailed => "區域網路連線失敗",
        TextKey::TransferRouteMismatch => "控制平面路由不符",
...
fn text_ja(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::TrayLan => "LAN",
        TextKey::TrayNoReachableDevices => "到達可能なデバイスはありません",
        TextKey::TrayViewAllDevices => "すべてのデバイスを表示...",
        ...
        TextKey::TransferUserCancelled => "転送がキャンセルされました",
        TextKey::TransferUserRejected => "受信者が転送を拒否しました",
        TextKey::TransferChecksumMismatch => "ファイルのチェックサム検証に失敗しました",
        TextKey::TransferStorageFull => "送信先のストレージ容量が不足しています",
        TextKey::TransferGeneric => "転送に失敗しました",
        TextKey::TransferRelayInactive => "非アクティブのため転送がタイムアウトしました",
        TextKey::TransferConnectionClosed => "接続が切断されました",
        TextKey::TransferSizeMismatch => "ファイルサイズが一致しません",
        TextKey::TransferHttpsIncomplete => "HTTPS 転送が完了しませんでした",
        TextKey::TransferOfferExpired => "転送リクエストの有効期限が切れました",
        TextKey::TransferLanFailed => "LAN 接続に失敗しました",
        TextKey::TransferRouteMismatch => "制御プレーンの経路が一致しません",
...
fn text_ko(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::TrayLan => "LAN",
        TextKey::TrayNoReachableDevices => "연결 가능한 디바이스 없음",
        TextKey::TrayViewAllDevices => "모든 디바이스 보기...",
        ...
        TextKey::TransferUserCancelled => "전송이 취소되었습니다",
        TextKey::TransferUserRejected => "수신자가 전송을 거절했습니다",
        TextKey::TransferChecksumMismatch => "파일 체크섬 검증에 실패했습니다",
        TextKey::TransferStorageFull => "대상 기기의 저장 공간이 부족합니다",
        TextKey::TransferGeneric => "전송에 실패했습니다",
        TextKey::TransferRelayInactive => "활동이 없어 전송 시간이 초과되었습니다",
        TextKey::TransferConnectionClosed => "연결이 끊어졌습니다",
        TextKey::TransferSizeMismatch => "파일 크기가 일치하지 않습니다",
        TextKey::TransferHttpsIncomplete => "HTTPS 전송이 완료되지 않았습니다",
        TextKey::TransferOfferExpired => "전송 요청이 만료되었습니다",
        TextKey::TransferLanFailed => "LAN 연결에 실패했습니다",
        TextKey::TransferRouteMismatch => "제어 경로가 일치하지 않습니다",
...
fn text_es(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::TrayLan => "LAN",
        TextKey::TrayNoReachableDevices => "No hay dispositivos accesibles",
        TextKey::TrayViewAllDevices => "Ver todos los dispositivos...",
        ...
        TextKey::TransferUserCancelled => "Transferencia cancelada",
        TextKey::TransferUserRejected => "El destinatario rechazó la transferencia",
        TextKey::TransferChecksumMismatch => "Error al verificar la suma de comprobación del archivo",
        TextKey::TransferStorageFull => "Almacenamiento lleno en el destino",
        TextKey::TransferGeneric => "Transferencia fallida",
        TextKey::TransferRelayInactive => "Tiempo de transferencia agotado por inactividad",
        TextKey::TransferConnectionClosed => "Conexión cerrada",
        TextKey::TransferSizeMismatch => "El tamaño del archivo no coincide",
        TextKey::TransferHttpsIncomplete => "La transferencia HTTPS no se completó",
        TextKey::TransferOfferExpired => "La oferta de transferencia expiró",
        TextKey::TransferLanFailed => "Falló la conexión LAN",
        TextKey::TransferRouteMismatch => "La ruta del plano de control no coincide",
...
fn text_de(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::TrayLan => "LAN",
        TextKey::TrayNoReachableDevices => "Keine erreichbaren Geräte",
        TextKey::TrayViewAllDevices => "Alle Geräte anzeigen...",
        ...
        TextKey::TransferUserCancelled => "Übertragung abgebrochen",
        TextKey::TransferUserRejected => "Empfänger hat die Übertragung abgelehnt",
        TextKey::TransferChecksumMismatch => "Dateiprüfsummenprüfung fehlgeschlagen",
        TextKey::TransferStorageFull => "Speicherplatz am Zielort voll",
        TextKey::TransferGeneric => "Übertragung fehlgeschlagen",
        TextKey::TransferRelayInactive => "Zeitüberschreitung bei der Übertragung wegen Inaktivität",
        TextKey::TransferConnectionClosed => "Verbindung geschlossen",
        TextKey::TransferSizeMismatch => "Dateigröße stimmt nicht überein",
        TextKey::TransferHttpsIncomplete => "HTTPS-Übertragung wurde nicht abgeschlossen",
        TextKey::TransferOfferExpired => "Dateiangebot ist abgelaufen",
        TextKey::TransferLanFailed => "LAN-Verbindung fehlgeschlagen",
        TextKey::TransferRouteMismatch => "Steuerungspfad stimmt nicht überein",
...
fn text_ru(key: TextKey) -> &'static str {
    match key {
        ...
        TextKey::TrayLan => "LAN",
        TextKey::TrayNoReachableDevices => "Нет доступных устройств",
        TextKey::TrayViewAllDevices => "Показать все устройства...",
        ...
        TextKey::TransferUserCancelled => "Передача отменена",
        TextKey::TransferUserRejected => "Получатель отклонил передачу",
        TextKey::TransferChecksumMismatch => "Не удалось проверить контрольную сумму файла",
        TextKey::TransferStorageFull => "Недостаточно места на целевом устройстве",
        TextKey::TransferGeneric => "Не удалось выполнить передачу",
        TextKey::TransferRelayInactive => "Превышено время передачи из-за неактивности",
        TextKey::TransferConnectionClosed => "Соединение закрыто",
        TextKey::TransferSizeMismatch => "Размер файла не совпадает",
        TextKey::TransferHttpsIncomplete => "HTTPS-передача не завершена",
        TextKey::TransferOfferExpired => "Срок действия предложения передачи истек",
        TextKey::TransferLanFailed => "Ошибка LAN-соединения",
        TextKey::TransferRouteMismatch => "Маршрут плоскости управления не совпадает",
